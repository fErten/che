...
public class CreateWorkspaceFromJavaMySqlCentosStackTest {
  ...
  public void checkWorkspaceCreationFromJavaStack() {
    ...
    consoles.startCommandFromProcessesArea("db", COMMON, "show databases", "information_schema");

    projectExplorer.waitAndSelectItem(WEB_JAVA_PETCLINIC);
    consoles.startCommandFromProcessesArea("dev-machine", COMMON, "build", BUILD_SUCCESS);
    ...
    consoles.startCommandAndCheckApp(currentWindow, "//h2[text()='Welcome']");
    consoles.closeProcessTabWithAskDialog("web-java-petclinic:build and deploy");
